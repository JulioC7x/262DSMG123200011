...
import com.example.sports.utils.getSportsContentType
...
fun SportsApp(
    ...
    val contentType = getSportsContentType(widthSizeClass)
...
/**
 * Displays the list and detail screens side by side
 * on expanded screens.
 */
@Composable
                ...
                Text(
                    ...
                    modifier = Modifier.padding(
                        bottom = dimensionResource(
                            R.dimen.card_text_vertical_space
                        )
                    )
                )
            ...
            Box {
                Image(
                    painter = painterResource(
                        selectedSport.sportsImageBanner
                    ),
                    contentDescription = null,
            ...
            Text(
                ...
                modifier = Modifier.padding(
                    vertical = dimensionResource(
                        R.dimen.padding_detail_content_vertical
                    ),
                    horizontal = dimensionResource(
                        R.dimen.padding_detail_content_horizontal
                    )
                )
            )
        }
